...
var _infobubble = __webpack_require__(377);

var _infobubble2 = _interopRequireDefault(_infobubble);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.InfoBubble = _infobubble2.default;
...
window.map = {
  ...
  init: function init() {
    ...
    for (markersLen; markersLen--;) {
      var type = th.data.mapOptions.markers[markersLen].type;
  ...
  build: function build() {
    ...
    if (mainMarker.html) {
      ...
      infoBubbleMainMarker = new _infobubble2.default({
        maxWidth: 400,
        minWidth: 400,
        map: th.map,
    ...
    for (markersLen; markersLen--;) {
      ...
      infoBubble2 = new _infobubble2.default({
        maxWidth: 400,
        minWidth: 400,
        map: th.map,
  ...
  onApiLoaded: function onApiLoaded() {
    ...
    if(map_placeholder.css('background-image') != "none")
    {
    	map_placeholder.css('cursor', 'pointer');
	    map_placeholder.css('background-position-x', '50%');
	    map_placeholder.css('background-position-y', '50%');
	    if(!clicked)
	    {
	    	map_placeholder.click(function(){
		        th.data.isApiLoaded = 1;
		        th.init();
		        map_placeholder.css('background-image', "");
		        clicked = true;
		    });
	    }
...
/* harmony default export */ __webpack_exports__["default"] = (InfoBubble);
